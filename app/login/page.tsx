  ...
  return (
    <div className="relative flex min-h-screen bg-background">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/4 -left-1/4 h-[600px] w-[600px] rounded-full bg-primary/10 blur-3xl" />
        <div className="absolute -right-1/4 -bottom-1/4 h-[600px] w-[600px] rounded-full bg-accent/10 blur-3xl" />
      </div>
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-card p-12 lg:flex">
        ...
        <div className="relative z-10">
          <blockquote className="text-2xl font-medium leading-relaxed text-balance">
            &ldquo;Nexus has transformed how our team collaborates and stays connected. It&apos;s not just social media, it&apos;s a community.&rdquo;
          </blockquote>
          <div className="mt-6 flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">Product Lead at TechCorp</div>
            </div>
          </div>
        </div>
